...
with sync_playwright() as p:
    ...
    page.pdf(path=os.path.join(DIR, "How-To-Get-Your-Planner.pdf"), width="816px", height="1056px", print_background=True)
    browser.close()

os.remove(tmp_path)
print("wrote How-To-Get-Your-Planner.pdf with link:", link)
